...
//=========================================================================================================================================================
        ...
        case "cansaco":
            return {
                ...
                frase: "Descanso é cuidado, não punição. CUIDE-SE! DESCANSE!"
            };
...
const meuStatusAgora = investigarBugHumano("falta de sol");
...
console.log("=== RELATÓRIO TÉCNICO DE SISTEMA ===");
console.log("O QUE ESTÁ ACONTECENDO: " + meuStatusAgora.diagnostico);
console.log("POR QUE ISSO ACONTECE: " + meuStatusAgora.explicacao);
console.log("O QUE FAZER: " + meuStatusAgora.instrucao);
console.log("MENSAGEM: " + meuStatusAgora.frase);
